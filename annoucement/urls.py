...
from .views import AnnoucementUpdateAndDelete , AnnoucementCategory, AnnoucementsByCategory ,AnnoucementList
from . import views
...
urlpatterns = [
    ...
    path('api/annoucements/category/', AnnoucementCategory.as_view(), name='annoucement_category'),
    path('api/annoucements/category/<int:id>', AnnoucementsByCategory.as_view(), name='annoucement_by_category'),
